  ...
  const fetchData = async () => {
    try {
      const { data } = await axios.get(
        "/api/v1/innovation/6669907ed37474022c4d3535"
      );
      console.log(data);
    } catch (error) {
      console.log(error);
      ...
      <div className="w-full">
        ...
        <div className="flex flex-wrap items-center justify-center max-w-[900px] mt-7 text-sm tracking-wide mx-auto">
          <div>
            ...
            <span>Name of Inventor Here</span>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-center max-w-[900px] mt-3 text-sm tracking-wide mx-auto ext-xs">
          <div className="flex items-center">
            ...
            <span className="flex gap-x-2">
              <Capsule>Farm Production</Capsule> <Capsule>Supply</Capsule>
            </span>
          </div>
          <div className="mx-4">|</div>
          <div className="flex items-center">
      ...
      <div>
        ...
        <div className="mt-10">
          ...
          <p className="leading-8">
            Lorem ipsum dolor sit amet consectetur. Gravida nunc cursus dolor
            feugiat dignissim id quam. Id rhoncus erat sit ut velit. Elit diam
            bibendum malesuada blandit convallis porttitor. Eu adipiscing nisl
            risus nunc neque at. Egestas velit pellentesque massa ipsum varius
            orci facilisis vehicula in. Ut accumsan fringilla posuere consequat
            ultricies eget.
          </p>
        </div>
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="mt-5 px-6">
                ...
                elit. Natus corporis expedita optio totam nobis architecto
                aperiam praesentium alias at nam?
              </AccordionContent>
            </AccordionItem>

...
const ProfilePage = () => {
  ...
  return (
    <div>
      <Navbar />
      <BreadcrumbP fromHref='/' fromTitle='Back to Home' toHref='/profile' toTitle='Profile page' />
      ...
      <div className='w-full flex flex-col items-center gap-y-10'>
          ...
          <div className='flex gap-x-6'>
            <Button variant="outline">Upload photo <LuUpload className='ml-2' /></Button>
            <Button variant="outline" className='text-destructive hover:text-destructive'>Delete photo <LuTrash2 className='ml-2' /></Button>
          </div>
      </div>

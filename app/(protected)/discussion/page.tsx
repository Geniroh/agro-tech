    ...
    <div>
      ...
      <div className='w-full container h-full'>
        <div className='flex justify-center items-center text-sm gap-x-2 my-10 font-semibold'>
              <Link href="/"><span className='text-[#888888]'>Back to HomePage</span></Link>
              /
              <span>Forum Page</span>
        </div>

        <h1 className='w-full text-center text-4xl font-playfair font-semibold my-10'>Disccussion Forum</h1>

        <div className='max-w-[700px] mx-auto'>
            <ChatCard username={"username"} email={"test@test.com"} id={"1"} placeholder='Create A Discussion'  />
            ...
            <div className='mt-5 pb-5 border-b'>
                <ReplyCard username='Innovation title' id={"1"} postedby='Posted 2 hours ago' />
            </div>
            <div className='mt-5 pb-5 border-b'>
                <ReplyCard username='Username' id={"1"} postedby='Posted 2 hours ago' message='What do you people think of value chain?' />
            </div>
            <div className='mt-5 pb-5 border-b'>
                <ReplyCard username='Innovation title' id={"1"} postedby='Posted 2 hours ago' />
            </div>
            <div className='mt-5 pb-5 border-b'>
                <ReplyCard username='Username' id={"1"} postedby='Posted 2 hours ago' />
            </div>
            <div className='mt-5 pb-5 border-b'>
                <ReplyCard username='Innovation title' id={"1"} postedby='Posted 2 hours ago' />
            </div>
        ...
        <div className='my-[100px] flex items-center justify-center'>
            <button className='flex gap-3 items-center bg-myoffwhie/50 text-mypurple px-3 py-1 rounded-2xl hover:text-white hover:bg-mypurple'>More <FaPlus /></button> 
        </div>
      </div>
    </div>
  )

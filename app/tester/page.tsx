...
//                   />
//                 </Form.Item>
//                 <Form.Item label="Email" required style={{ marginRight: 10 }}>
//                   <Input
//                     value={person.email}
//                     onChange={(e) =>
...
//             ))}
//             <Form.Item>
//               <Button type="dashed" onClick={addPerson} icon={<PlusOutlined />}>
//                 Add Person
//               </Button>
//             </Form.Item>
//           </div>
...
const MyComponent: React.FC = () => {
  ...
  useEffect(() => {
    if (selectValue === "yes" && people.length === 0) {
  ...
  const removePerson = (index: number) => {
    if (index === 0) return; // Prevent removal of the first person
    setPeople(people.filter((_, i) => i !== index));
  };

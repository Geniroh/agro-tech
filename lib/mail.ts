...
<body style="padding: 40px; 
    ...
    <div >
        ...
        padding-bottom: 44px;">
            <p>Hi ${name},</p>
            <p>We’re glad to have you onboard! and uploading your innovation. Our staff are currently reviewing your innovation and would be approved in 2-3 working days.</p>
            <p>If there’s anything you need, we’ll be here every step of the way.</p>
            <div>
                Thanks, <br/> StavMia
            </div>
        </div>
